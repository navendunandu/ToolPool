...
{
	$cat=$_POST["txtcat"];
	$selqry="select * from tbl_category where category_name='".$cat."'";
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
			<h1 align="center"><u>CATEGORY</u></h1>
<form id="form1" name="form1" method="post" action="">
  <table width="310" border="0" align="center">
    <tr>
      <td width="106" align="left">Category</td>
      <td width="194" align="center"><label for="txtcat"></label>
      <input type="text" name="txtcat" id="txtcat" required="required" /></td>
    </tr>
    <tr>
  ...
  <table width="381" border="1" align="center">
	...
	<tr>
		...
		<td><a href="Category.php?id=<?php echo $row["category_id"];?>">Delete</a></td>
	</tr>
	<?php			 
	  }
	  ?>
