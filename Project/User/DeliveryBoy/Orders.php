...
<head>
    <meta charset="utf-8">
    <title>DeliveryBoy-Returns</title>
...
<body>
    ...
    <?php
  $viewqry="select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_tool t on t.tool_id=c.tool_id INNER JOIN tbl_user u on u.user_id=b.user_id INNER JOIN tbl_toolshop s on t.toolshop_id=s.toolshop_id where booking_status=6 or booking_status=5 and boy_id='".$_SESSION['boyid']."'";
