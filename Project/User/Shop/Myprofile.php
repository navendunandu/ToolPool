...
$viewqry="select * from tbl_toolshop s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district d on d.district_id=p.district_id where toolshop_id='".$_SESSION['shopid']."'";
...
<div class="d-flex justify-content-center mb-2" style="flex-direction: column;">
              ...
              <a href="My Chat.php" class="btn btn-primary">My Chat</a>
            </div>
          </div>
        </div>
      </div>
