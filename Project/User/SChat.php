...
$sel = "select * from tbl_toolshop where toolshop_id='".$_GET["id"]."'";
               $res = $conn->query($sel);
                $row=$res->fetch_assoc();
?>
    <!DOCTYPE html>
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="../Assets/File/Shop/<?php echo $row["toolshop_logo"] ?>" alt="">
                            </div>
                            <div class="username">
                                <span><?php echo $row["toolshop_name"] ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
