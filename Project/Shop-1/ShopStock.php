...
if(isset($_POST["btnadd"]))
{
	...
	if($re=$conn->query($insqry))
	{
		...
		header("Location:../Shop/ShopStock.php?sid=".$toolid);
	}
	else
	{
...
<form id="form1" name="form1" method="post" action="">	
  ...
  <input type="hidden" value="<?php echo $_GET['sid'];?>" name="txtid" id="txtid" class="form-control"/>
    <tr>
      <td>Date</td>
  ...
  <?php
    ...
    <tr>
      ...
      <td><a href="ShopStock.php?id=<?php echo $row["stock_id"];?>">Delete</a></td>
    </tr>
    <?php } ?>
  </table>
  <?php
