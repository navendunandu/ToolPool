...
if(isset($_POST["btnsubmit"]))
{
	...
	$selqry="select * from tbl_complainttype where complainttype_name='".$complainttype."'";
...
if(isset($_GET["id"]))
{
	$delqry="delete from tbl_complainttype where complainttype_id='".$_GET["id"]."'";
...
<head>
    <meta charset="utf-8">
    <title>ToolPool-Complaint Type</title>
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="ComplaintType.php" class="dropdown-item active">Complaint Type</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
<h1 align="center"><u>Complaint Type</u></h1>
<form id="form1" name="form1" method="post" action="">
  <table width="351" border="0" align="center">
    <tr>
      <td width="170" align="left">Complaint Type </td>
      <td width="165" align="center"><label for="txtname"></label>
      <input complainttype="text" name="txtname" id="txtname" required="required"/></td>
    </tr>
    <tr>
  ...
  <table width="361" border="1" align="center">
      <tr>
        ...
        <td width="182">Complaint Type </td>
	...
	<tr>
		...
		<td><a href="complainttype.php?id=<?php echo $row["complainttype_id"];?>">Delete</a></td>
	</tr>
	<?php			 
	  }
	  ?>
