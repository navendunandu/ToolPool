...
<head>
    <meta charset="utf-8">
    <title>ToolPool-Complaints</title>
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Complaints.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Complaints</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
<h3 align="center">NEW COMPLAINTS</h3>
<?php
...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" align="center">
	...
	$i=0;
		...
		while($row=$result->fetch_assoc())
		{
            ...
            <td><a href="Showcomplaints.php?cid=<?php echo $row["complaint_id"];?>">View More</a></td>
            </tr>
            <?php	
		}
		?>
  ...
  <?php
   ...
   ?>
   <?php
   $selqry1="select * from tbl_complaint c inner join tbl_user u on c.user_id=u.user_id where complaint_status='1'";
   ?>
   <h3 align="center">SOLVED COMPLAINTS</h3>
  <?php
  ...
  <table width="200" border="1" align="center">
	...
	$j=0;
		...
		while($row1=$result1->fetch_assoc())
		{
            ...
            <tr>
            <td><?php echo $j;?></td>
            <td><?php echo $row1["complaint_title"];?></td>
            <td><?php echo $row1["user_name" ];?></td>
            <td><?php echo $row1["complaint_reply" ];?></td>
            </tr>
            <?php	
		}
		?>
