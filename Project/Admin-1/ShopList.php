...
$viewqry="select * from tbl_toolshop s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district d on d.district_id=p.district_id";
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
    <div class="container">
        <div class="shoplist" style="margin: 20px;">
            <div class="row" style="margin-top: 40px;">
            <?php
            if($re->num_rows>0)
            { ?>
            <h1 align="center"><b><u align="center">Shop List</u></b></h1>
            </div>
            <div class="row" style="margin-top: 30px;">
                <form id="form1" name="form1" method="post" action="">
                <table width="759" class="table" border="1" style="border-color: #6c7293; border-width: initial;">
                    <tr>
...
function ShopList(id){
                    $("#loder").show();
                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxShopList.php?id=" + id,
                        success: function(response) {
                            $("#result").html(response);
                            $("#loder").hide();
                            $("#textChange").text("Filtered Shop List");
                        }
                    });
                }
</script>
