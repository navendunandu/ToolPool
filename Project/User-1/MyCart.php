...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
               ...
               $res = $conn->query($sel);
                while ($row=$res->fetch_assoc()) {
                    ...
                    if ($rowpr=$respr->fetch_assoc()) {
                        ...
                        $selstock1="select sum(cart_qty) as Qty from tbl_cart where tool_id='".$rowpr["tool_id"]."' and cart_status>'0'";
            ...
            <div class="product">
                ...
                <div class="product-price "	><?php echo $rowpr["tool_rentprice"] ?></div>
