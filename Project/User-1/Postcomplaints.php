...
if(isset($_POST["btnsubmit"]))
{
	...
	$insqry="insert into tbl_complaint(complaint_title,complaint_content,user_id,booking_id,complainttype_id)values('".$ctitle."','".$content."','".$_SESSION['userid']."','".$_GET['id']."','".$ctype."')";
