        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Out for Delivery</th>
                    <th style="text-align:center">Delivered</th>
                    <th style="text-align:center">Out for PickUp</th>
			...
			<?php
				include('../Assets/Connection/Connection.php');
                 ...
                 $o=0;
			 	 ...
			 	 $selQry = "select * from tbl_booking where true";
				 ...
				 if(isset($_POST["btn_search"]))
                   ...
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   if($data["booking_status"]==0 || $data["booking_status"]==1 || $data["booking_status"]==2 || $data["booking_status"]==3)
					   {
						   $j++;
					   }
					   if($data["booking_status"]==7 || $data["booking_status"]==6)
					   {
						   $k++;
					   }
                       ...
                       if($data["booking_status"]==10)
					   {
						   $m++;
					   }
					   if($data["booking_status"]==9)
					   {
						   $n++;
					   }
                       if($data["booking_status"]==9)
