...
$viewqry="select * from tbl_toolshop s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district d on d.district_id=p.district_id  where toolshop_vstatus=2;";
...
<head>
    <meta charset="utf-8">
    <title>ToolPool-Rejected Shops</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
				...
				<a href="ShopList.php" class="dropdown-item ">Shop List</a>
                            ...
                            <a href="ShopListRejected.php" class="dropdown-item active">Shop List Rejected</a>
                        </div>
                    </div>
...
if($re->num_rows>0)
{ ?>
<h1 align="center"><b><u>Rejected Shop List</u></b></h1>	
...
{
	echo "<h1 align='center'>No Shop Rejected</h1>";
} ?>
</div>
        <!-- Content End -->
        <!-- Back to Top -->
