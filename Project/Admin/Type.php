...
{
	$type=$_POST["txttype"];
	$selqry="select * from tbl_type where type_name='".$type."'";
...
if(isset($_GET["id"]))
{
	$delqry="delete from tbl_type where type_id='".$_GET["id"]."'";
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="Type.php" class="dropdown-item active">Type</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
<h1 align="center"><u>MACHINE TYPE</u></h1>
<form id="form1" name="form1" method="post" action="">
  <table width="310" border="0" align="center">
    <tr>
      <td width="119" align="left">Type Name</td>
      <td width="181" align="center"><label for="txttype"></label>
      <input type="text" name="txttype" id="txttype" /></td>
    </tr>
    <tr>
    	<td height="42" colspan="2" align="center" valign="middle"><input type="submit" name="btnsubmit" id="btnsubmit" value="Submit" /></td>
    </tr>
  </table>
	<?php
  ...
  <table width="261" border="1" align="center">
	...
	<tr>
		...
		<td><a href="Type.php?id=<?php echo $row["type_id"];?>">Delete</a></td>
	</tr>
	<?php			 
	  }
	  ?>
