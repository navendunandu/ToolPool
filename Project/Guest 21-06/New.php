...
<form id="form1" enctype="multipart/form-data" name="form1" method="post" action="">
  <table width="545" border="1" align="center">
    <tr>
      ...
      <input type="txtname" name="txtname" id="txtname" /></td>
    </tr>
    <tr>
      <td>Contact</td>
      <td><label for="txtcontact"></label>
      <input type="txtcontact" name="txtcontact" id="txtcontact" pattern="([0-9]{10,10})" /></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><label for="txtmail"></label>
      <input type="txt" name="txtmail" id="txtmail" /></td>
    </tr>
    <tr>
      <td>Address</td>
    ...
    <tr>
      ...
      <select name="txtdist" id="txtdist" onChange="getplace(this.value)">
