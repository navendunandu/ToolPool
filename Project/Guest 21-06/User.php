...
if(isset($_POST["btnsave"]))
{
	...
	move_uploaded_file($temp,'../Assets/File/User/'.$proof);
	$pw=$_POST["txtpw"];
	$cpw=$_POST["txtcpw"];
	$insqry="insert into tbl_user(user_name, user_contact, user_email, user_gender, user_address,  place_id, user_password,user_photo, user_proof, user_doj) values('".$name."','".$contact."','".$mail."','".$gender."','".$address."','".$district."','".$pw."','".$photo."','".$proof."',curdate())";
	if($pw==$cpw)
	{
	...
	{
		echo "<script>alert ('Registration Un	Successful')</script>";
	}
	}
}
?>
...
<div class="container h-100">
  ...
  <tr>
    <th scope="row" style="vertical-align: middle; border-top: none;"><h1>User Registration</h1></th>
...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
  <table width="354" border="0" align="center" class="table">
    ...
    <tr>
      ...
      <input type="text" name="txtno" id="txtno" pattern="([0-9]{10,10})" class="form-control" required /></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><label for="txtemail"></label>
      <input type="email" name="txtemail" id="txtemail" class="form-control" required/></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td><input type="radio" name="radgen" id="radgen2" value="Male" required />
      Male 
      <label for="radgen"></label>
      <input type="radio" name="radgen" id="radgen3" value="Female" required />
      Female
<label for="radgen2">
  <input type="radio" name="radgen" id="radgen" value="Others" required />
  Others</label></td>
    </tr>
    <tr>
      <td>Address</td>
      <td><label for="txtad"></label>
      <textarea name="txtad" id="txtad" cols="30" rows="5" class="form-control"  required></textarea></td>
    </tr>
   <tr>
      <td>District</td>
    ...
    <tr>
      ...
      <input type="password" name="txtpw" id="txtpw" class="form-control"  required/></td>
    </tr>
    <tr>
      <td>Confirm Password</td>
      <td><label for="txtcpw"></label>
      <input type="password" name="txtcpw" id="txtcpw" class="form-control" required /></td>
    </tr>
    <tr>
