...
<a href="ToolPool-Login.php"><img src="../Assets/images/tp.png" height="150px"></a></div>
...
<form id="form1" enctype="multipart/form-data" name="form1" method="post" action="">
  <table width="434" border="0" align="center" class="table">
    ...
    <tr>
      ...
      <input type="text" name="txtmail" id="txtmail"class="form-control" required /></td>
    </tr>
    <tr>
      <td>Contact No:</td>
      <td><label for="txtcontact"></label>
      <input type="text" name="txtcontact" id="txtcontact" class="form-control"required  /></td>
    </tr>
    <tr>
      <td>Address</td>
      <td><label for="txtaddress"></label>
      <textarea name="txtaddress" id="txtaddress" cols="45" rows="5"class="form-control" required ></textarea > </td>
    </tr>
    <tr>
      <td>District</td>
    ...
    <tr>
      ...
      <input type="password" name="txtpassword" id="txtpassword" class="form-control" required /></td>
    </tr>
    <tr>
    <td>Confirm Password</td>
      <td><label for="txtcpassword"></label>
      <input type="password" name="txtcpassword" id="txtcpassword" class="form-control" required /></td>
    </tr>
